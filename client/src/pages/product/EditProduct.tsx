...
const EditProduct = () => {
  ...
  const onSubmit: SubmitHandler<ProductSchema> = async (value) => {
    ...
    try {
      ...
      const existingImages = currentImages.filter((img): img is string => typeof img === 'string');
      const newUploadedImages = currentImages.filter((img): img is File => typeof img === 'object');
  ...
  const handleAddImage = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    form.setValue('images', [...form.getValues('images'), ...Array.from(files || [])]);
  }
