...
const About = () => {
  return (
    <div className='mt-20 mb-20 w-96 mx-auto px-4'>
      <div className='mb-20'>
        <h1 className='text-lg font-semibold'>Can Meet とは</h1>
        <p className='text-xs'>
          can
          meetは、バンクーバーに住むすべての日本人のためのフリマアプリです。海を越えて新しい国で生活を送る日本人の皆さまが、より安心して・より良い価格で、買えるモノ・売れる機会に出会えます（＝can
          meet）ように！
        </p>
      ...
      <div className=''>
        ...
        <p className='text-xs'>
          can
          meetは、バンクーバーのカレッジで出会ったcoop留学生3人によって開発されました。皆さまのフィードバックを受けて、より良いアプリ運営を行っていきます。今後ともよろしくお願いします！
        </p>
